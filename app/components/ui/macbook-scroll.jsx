...
export const MacbookScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0, 6], [0, 1500]);
  const rotate = useTransform(scrollYProgress, [0.1, 0.10, 0.3], [-28, -28, 0]);
...
export const OptionKey = ({ className }) => {
    return (
      <img src="./images/cv.jpg" alt="CV Icon" className={className} />
    );
  };
  
  const AceternityLogo = ({ className }) => {
    return (
